...
def main() -> int:
    ...
    unknown_text = (
        f" {counts['unknown']} have insufficient evidence for a current status."
...
<section id="agd-static">
  ...
  {counts['guarantee_elapsed']} have passed their stated guarantee period without a confirmed stop, and {counts['ended']} are confirmed no longer supported.{unknown_text}
